...
const countriesReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case GET_ACTIVITIES_BY_ID:
      ...
      const actividadFiltrada = state.activities.find(
        (actividad) => actividad.id === activityId
      );
    ...
    case FILTER_BY_CONTINENT:
      ...
      const filterContinent =
        action.payload === "All"? allCountries : allCountries.filter((element) => element.continent === action.payload
            );
      return {
        ...state,
